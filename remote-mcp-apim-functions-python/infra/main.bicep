...
@description('The pricing tier (SKU) of the API Management service. Basicv2 or higher is required for the MCP/OAuth gateway policies this sample uses. Consumption is cheaper but does not support every policy here.')
