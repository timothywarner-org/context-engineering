// Azure Bicep template for Analytics MCP Server
...
// Variables
var resourceNamePrefix = 'analytics-mcp-${environmentName}'
  ...
  properties: {
    ...
    template: {
      containers: [
        {
          name: 'analytics-mcp'
          image: '${containerRegistryName}.azurecr.io/analytics-mcp:${imageTag}'
          resources: {
            cpu: json('0.25')
            memory: '0.5Gi'
          }
