...
# Azure deployment script for Knowledge Base MCP Server
# Builds Docker image, pushes to ACR, and deploys to Container Apps

set -e

# Configuration
RESOURCE_GROUP="${RESOURCE_GROUP:-kb-mcp-rg}"
LOCATION="${LOCATION:-eastus}"
ENVIRONMENT="${ENVIRONMENT:-dev}"
ACR_NAME="${ACR_NAME:-kbmcpacr$(openssl rand -hex 4)}"
IMAGE_NAME="knowledge-base-mcp"
IMAGE_TAG="${IMAGE_TAG:-$(git rev-parse --short HEAD 2>/dev/null || echo 'latest')}"
API_KEY="${API_KEY:-$(openssl rand -base64 32)}"

echo "======================================================================"
echo "🚀 Knowledge Base MCP Server - Azure Deployment"
echo "======================================================================"
echo ""
echo "Configuration:"
...
CONTAINER_APP_NAME="kb-mcp-${ENVIRONMENT}-app"
