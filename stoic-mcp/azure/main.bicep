// ============================================================
// Stoic MCP - Azure Infrastructure (MVP Edition)
// ============================================================
...
param containerImage string = 'stoic-mcp:latest'
...
var cosmosAccountName = 'stoic-cosmos-${uniqueSuffix}'
var containerAppName = 'stoic-app-${uniqueSuffix}'
var containerAppEnvName = 'stoic-env-${uniqueSuffix}'
var keyVaultName = 'stoic-kv-${uniqueSuffix}'
var logAnalyticsName = 'stoic-logs-${uniqueSuffix}'
...
// ============================================================
// Cosmos DB Container (Quotes Collection)
// ============================================================
  ...
  properties: {
    resource: {
      ...
      indexingPolicy: {
        ...
        excludedPaths: [
          {
            path: '/"_etag"/?'  // Optimize: don't index system fields
          }
        ]
      }
    }
...
// ============================================================
// Cosmos DB Container (Metadata Collection)
// ============================================================

resource cosmosMetadataContainer 'Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers@2023-11-15' = {
  parent: cosmosDatabase
  name: 'metadata'
  properties: {
    resource: {
