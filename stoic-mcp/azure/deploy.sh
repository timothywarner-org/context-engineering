...
# ============================================================
# This script deploys the Stoic MCP server to Azure
# Requirements:
...
log_info "Starting Stoic MCP Azure Deployment"
echo ""
...
if [ -z "$DEEPSEEK_KEY" ]; then
    log_warning "No API key provided. Quote explanations will not be available."
...
log_info "  - Cosmos DB (Free Tier) with 'quotes' and 'metadata' containers"
...
echo "   az cosmosdb sql container show -g $RESOURCE_GROUP -a $COSMOS_ACCOUNT -d $COSMOS_DATABASE -n quotes"
echo ""
...
echo ""
log_info "Note: The database starts empty. You can populate it via MCP tools or bulk import."
echo ""
